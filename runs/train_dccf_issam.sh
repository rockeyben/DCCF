...
CUDA_VISIBLE_DEVICES=0 python3 train.py \
    models/fixed256/issam_dccf_LR_hsv_1_clamp.py \
    --ngpu 1 \
    --workers 8 \
    --batch-size 16 \
    --exp-name=v1
...
low_res_weights='harmonization_exps/fixed256/issam_dccf_LR_hsv_1_clamp/000_v1/checkpoints/119.pth'
...
# test
weights="harmonization_exps/fixed256/issam_dccf_HR_hsv_1_clamp/000_v1/checkpoints/049.pth"

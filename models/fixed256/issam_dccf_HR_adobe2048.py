...
def train(model, cfg, model_cfg, start_epoch=0):
    ...
    loss_cfg.pixel_loss_fullres_weight = wl * 10.0
    ...
    dir_adobe = cfg.HADOBE5K_2048_PATH


    trainset = ComposeDatasetUpsample(
        [
            HDatasetUpsample(dir_adobe, split='train', blur_target=blur),
        ],
    ...
    valset = ComposeDatasetUpsample(
        [
            HDatasetUpsample(dir_adobe, split='test', blur_target=blur),
        ],

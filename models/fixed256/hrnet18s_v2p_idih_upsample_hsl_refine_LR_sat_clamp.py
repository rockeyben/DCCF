...
def init_model(cfg):
    ...
    ccfg = BMCONFIGS['improved_dih256_hsl_refine_LR_sat_clamp']
...
def train(model, cfg, model_cfg, start_epoch=0):
    ...
    loss_cfg.pixel_loss_fullres_weight = 0.0

    wl = 1.0
    blur = False
    use_hr = BMCONFIGS['improved_dih256_hsl_refine_LR_sat_clamp']['params']['use_hr'] # False
    ...
    train_augmentator_1 = None

    train_augmentator_2 = HCompose([
        RandomResizedCrop(*low_res_size, scale=(0.5, 1.0)),
        HorizontalFlip(),
    ])

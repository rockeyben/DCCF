...
CUDA_VISIBLE_DEVICES=0 python scripts/predict_interactive.py hrnet18s_v2p_idih256_upsample_hsl_refine_HR ${weights} \
    --images harmonization_exps/interactive_images/ \
    --masks harmonization_exps/interactive_images/ \
    --channel L \
...
CUDA_VISIBLE_DEVICES=0 python scripts/predict_interactive.py hrnet18s_v2p_idih256_upsample_hsl_refine_HR ${weights} \
    --images harmonization_exps/interactive_images_H/ \
    --masks harmonization_exps/interactive_images_H/ \
    --channel H \
